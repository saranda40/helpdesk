...
#SECRET_KEY = 'django-insecure-q_$3himt&przywp%s0g-k7=+l7bo1p2&f1567im4$*%=5tq(j@'

SECRET_KEY = os.environ.get('SECRET_KEY', default='S2b1st1@n###___@23GYRddfgf+dfgd')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'usuarios.authentication.BearerTokenAuthentication',
        'rest_framework.authentication.TokenAuthentication',
        # Si usas otras clases de autenticación, ponlas aquí
    ),
